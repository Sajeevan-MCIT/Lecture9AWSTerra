...
// number of public and private subnets variable
...
variable "settings" {
    ...
    default = {
        "database"= {
            ...
            gigabyengine = "mysql" // engine type
        ...
        "web_app" = {
        count =2  // the number of EC2 instances "t2.micro" 
        instance_type = "t.2 micro" // the EC2 instance
        }
    }
}
